...
if __name__ == '__main__':
    ...
    x_1 = 10 * np.random.rand(500) - 5 # x is between -5 and 5
    ...
    with pm.Model() as model_sd_10:    # al doilea cel mai sensibil la zgomote
        α = pm.Normal('α', mu=0, sigma=1)
    ...
    with pm.Model() as model_sd_100:    # cel mai sensibil la zgomote
        α = pm.Normal('α', mu=0, sigma=1)
    ...
    with pm.Model() as model_sd_np:     # cel mai putin sensibil la zgomote
        α = pm.Normal('α', mu=0, sigma=1)
